...
class Ui_MainWindow(object):
    ...
    def decision(self, text):
        ...
        #class post message do

        msg = QMessageBox()
        msg.setIcon(QMessageBox.Information)

        msg.setInformativeText(text)
        msg.setWindowTitle("do you want to scrape this topic")
        msg.setDetailedText("The details are as follows:")
        msg.setStandardButtons(QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No | QMessageBox.Cancel)
        retval = msg.exec_()
        print(retval)
        ...
        for url in numeracja:
            ...
            for i in b:
                ...
                if i.text == 'Reply':
                    ...
                    text = 'https://boards.4chan.org/' + podstrona + i['href']
                    print("text linku "+text)
                    # self.textBrowser.setText('https://boards.4chan.org/' + podstrona + i['href'])
                    # self.textBrowser.repaint()

                    check = self.decision(text)
...
class Ui_MainWindow(object):
    ...
    def decision(self, text):
        ...
        msg.setText("do you want to scrape this topic")
        msg.setInformativeText(text)
        msg.setWindowTitle("do you want to scrape this topic")
        msg.setDetailedText("The details are as follows:")
        msg.setStandardButtons(QtWidgets.QMessageBox.Yes |QtWidgets.QMessageBox.No | QMessageBox.Cancel)
